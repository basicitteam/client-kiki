<div class="span9 well">
	<div id="main" class="alert alert-info">
		<section>
			<article>
				<form class="form-horizontal" action="<?php echo site_url('siswa/update'); ?>" method="POST" enctype="multipart/form-data">
					<fieldset>
						<legend>Edit Siswa</legend>
						<div class="control-group">
						<label class="control-label" for="nis">Nis</label>
						<div class="controls">
							<input type="text" class="input-large" readonly="true" id="nis" name="nis">
						</div>
						</div>
						<div class="control-group">
