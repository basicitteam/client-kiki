					...
					<div class="span9 well">
						<div class="alert alert-info">
							...
							<form class="form-search" style="padding-top:15px" method="post" action="<?php echo site_url('admin/kelas/add'); ?>">
								...
								<div class="span10">
									<table class="table table-striped">
										...
										<tbody>
											...
											<td>
											<a class="btn btn-primary pull-right" href="<?php echo site_url('admin/kelas/edit/'.$value['id_kelas']); ?>">
											<i class="icon-edit"></i>
											Edit
											</a>
											</td>
											<td>
												<form method="post" action="<?php echo site_url('admin/kelas/delete/'); ?>">
